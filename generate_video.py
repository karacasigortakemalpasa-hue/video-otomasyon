...
characters. It should still clearly signal the real, concrete topic (the actual name/event), not be pure
abstract clickbait — curiosity AND clarity together, not one instead of the other.
